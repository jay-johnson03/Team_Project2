module project2.project2 {
    ...
    // opens the project2.project2 package to javafx.fxml and
    // project2.project2.controllers to javafx.fxml so that the fxml files can
    // access the controller classes
    opens project2.classes to javafx.base;
